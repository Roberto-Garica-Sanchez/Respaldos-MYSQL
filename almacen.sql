...
-- Tiempo de generación: 02-07-2021 a las 19:36:21
...
CREATE TABLE `clientes` (
  ...
  `Estatus` set('Activo','Inactivo') NOT NULL DEFAULT 'Activo'
...
CREATE TABLE `unidades` (
  ...
  `N_eco` varchar(15) NOT NULL,
  `Color` varchar(15) NOT NULL,
  `Estatus` set('Activo','Inactiva') NOT NULL DEFAULT 'Activo'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
